...
export const updateUserForm2 = [
      {
        name: "hasNewsletter",
        label: "Jeg ønsker at modtage nyheder om klima-indsatsen, gode tilbud, ekslusive deals og lignende promoverings-mails fra den grønne avis og samarbejds-parnere?",
        type: "checkbox",
      },
      {
        name: "hasNotification",
        label: "Jeg ønsker at modtage notifikationer i form af emails når der sker en opdatering på en af mine annoncer eller jeg modtager en ny henvendelse?",
        type: "checkbox",
      },
